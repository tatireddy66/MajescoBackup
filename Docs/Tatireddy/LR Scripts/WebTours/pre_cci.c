# 1 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c"
...
# 1 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c" 2
...
# 2 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c" 2
...
# 3 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c" 2
...
# 4 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c" 2
...
web_reg_save_param_ex("param=flight","LB=name=\"userSession\" value=\"","RB=\"/>","ORD=1", "LAST");
	...
	web_submit_data("login.pl", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=userSession", "Value={flight}", "ENDITEM", 
	...
	web_submit_data("reservations.pl", 
		...
		"Name=departDate", "Value=06/29/2016", "ENDITEM", 
		"Name=arrive", "Value=London", "ENDITEM", 
		"Name=returnDate", "Value=06/30/2016", "ENDITEM", 
	...
	lr_end_transaction("find flights",2);

	lr_think_time(18);

	lr_start_transaction("Find Flights Continue");
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		"ITEMDATA", 
		"Name=outboundFlight", "Value=020;338;06/29/2016", "ENDITEM", 
		"Name=numPassengers", "Value=1", "ENDITEM", 
		"Name=advanceDiscount", "Value=0", "ENDITEM", 
		"Name=seatType", "Value=Coach", "ENDITEM", 
		"Name=seatPref", "Value=None", "ENDITEM", 
...
# 128 "Action.c"
	...
	web_url("iecompatviewlist.xml", 
		"URL=https://iecvlist.microsoft.com/IE11/1379465767093/iecompatviewlist.xml", 
		"TargetFrame=", 
		"Resource=0", 
	...
	lr_end_transaction("Find Flights Continue",2);
...
# 5 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c" 2
...
# 6 "d:\\tatireddy\\lr scripts\\webtours\\\\combined_WebTours.c" 2
